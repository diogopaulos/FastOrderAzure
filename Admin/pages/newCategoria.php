<?php 
  ...
  if (isset($_POST["submit"])){
    ...
    $category->setNomeCategoria($NomeCategoria);
                ...
                <?php if ($categoryError == true) { ?>
                  <div class="form-group mb-3">
                    <div class="alert alert-danger" role="alert">
                      O nome da categoria está inválido!
                    </div>
                  </div>
                <?php } ?>
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input name="NomeCategoria" class="form-control" placeholder="Nome da Categoria" type="username" required>
                  </div>
                </div>
