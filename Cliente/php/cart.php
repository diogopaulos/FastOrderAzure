<?php
  class Cart {
    ...
    public function createCart() {
			...
			$sql = "INSERT INTO pedido_detalhes_temp(sessionID, idProduto, Quantidade, Tamanho, Preco, HoraEntrega, CreateDate) 
				VALUES ('" . $this->sessionID . "', '" . $this->idProduto . "', '" . $this->Quantidade . "', '" . $this->Tamanho . "', '" . $this->Preco . "', '" . $this->HoraEntrega . "', '" . $this->CreateDate . "')";
