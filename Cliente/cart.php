...
<body class="sub_page">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Preço</th>
                                        <th>
                                            <button type="submit" name="refreshCart" class="reload-cart-btn"
                        ...
                        <div class="shoping__checkout">
                            <?php if($countCart != 0) { ?>
                                <?php if(!isset($_SESSION['login_cliente']) || $_SESSION['login_cliente'] != true){ ?>
                                    <a href="checkout.php" class="primary-btn">Continue para o Pagamento</a>
                                <?php } else { ?>
                                    <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#confirmPedido" style="width: 100%;border: 0;">
    ...
    <div id="confirmPedido" class="modal fade" style="overflow-y: hidden;">
        <div class="modal-dialog modal-dialog-centered modal-confirm">
            <div class="modal-content">
                <div class="modal-header flex-column text-center" style="border: 0;">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <h4 class="modal-title w-100">Dados do pagamento</h4>
                </div>
                <div class="modal-body text-center">
                    <p style="font-size: 20px ;overflow-wrap: break-word !important;">
                        Deseja usar os dados do seu perfil?
                    </p>
                </div>
                <div class="modal-footer justify-content-center" style="border: 0;">
                    <a href="checkout.php">
                    ...
                    <form action="" method="post">
                        <button type="submit" name="" class="btn btn-danger">Sim</button>
                    </form>
                </div>
            </div>
        </div>
